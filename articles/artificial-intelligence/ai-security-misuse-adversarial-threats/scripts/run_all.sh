...
echo
echo "Checking Rust residual-risk checker..."
...
echo
echo "Checking Go AI security monitoring service build..."
...
echo
echo "Checking C++ residual-risk scorer..."
if command -v g++ >/dev/null 2>&1; then
  g++ -std=c++17 "$ARTICLE_DIR/cpp/residual_risk_scorer.cpp" -o "$ARTICLE_DIR/outputs/residual_risk_scorer"
  "$ARTICLE_DIR/outputs/residual_risk_scorer"
else
